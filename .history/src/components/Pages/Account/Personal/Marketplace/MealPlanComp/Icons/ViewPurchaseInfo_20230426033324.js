...
function ViewPurchaseInfo(props) {
  const { t } = useTranslation();
	...
	const pay = (e, bookingId, consultantId, eventType) => {
		e.preventDefault();

		props.purchaseBooking(bookingId, consultantId, eventType);
	};
...
=======
									<div className="">
										...
										<Button
											...
											onClick={(e) =>
												pay(e, bookingId, consultantId, eventType)
											}
										>
											{isLoading
												? "loading"
...
const mapDispatchToProps = (dispatch) => {
	return {
		...
		purchaseBooking: (bookingPurchaseId, consultantId, eventType) =>
			dispatch(
				changePurchaseStatus(bookingPurchaseId, consultantId, eventType)
			),
	};
};
