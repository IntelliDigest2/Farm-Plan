...
function ViewPurchaseInfo(props) {
	...
	const pay = (e, bookingId, eventType, consultantId) => {
		e.preventDefault();
		console.log(bookingId, eventType, consultantId);
		props.purchaseBooking(bookingId, eventType, consultantId, props.auth.uid);
	};
...
const mapDispatchToProps = (dispatch) => {
	return {
		...
		purchaseBooking: (bookingPurchaseId, eventType, userId, consultantId) =>
			dispatch(
				changePurchaseStatus(bookingPurchaseId, eventType, consultantId, userId)
			),
	};
};
