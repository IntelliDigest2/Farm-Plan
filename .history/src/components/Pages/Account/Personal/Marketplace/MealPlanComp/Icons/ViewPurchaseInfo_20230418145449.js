...
function ViewPurchaseInfo(props) {
	...
	function pay() {
		editBookingPurchaseStatus({ bookingId, eventType });
	}
...
const mapDispatchToProps = (dispatch) => {
	return {
		...
		editBookingPurchaseStatus: (bookingPurchaseId, eventType) =>
			dispatch(editBookingPurchaseStatus(bookingPurchaseId, eventType)),
	};
};
