...
import { fetchConsultantData } from "../../../../../store/actions/consultantActions";
...
function AvailabilityOrganiser(props) {
	...
	const consultantId = "EAudRc5YajVorKygb0kZFGlfl163";
	...
	if (consultantCalendarEvents.length > 0) {
		localEventArray = transformUTCtoLocalTime(consultantCalendarEvents);
	}
	...
	let calendarEmpty =
		consultantCalendarEvents.length === 0
