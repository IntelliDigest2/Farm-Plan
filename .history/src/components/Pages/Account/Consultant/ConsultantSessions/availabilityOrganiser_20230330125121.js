...
function AvailabilityOrganiser({ consultantCalendarInfo }) {
	...
	console.log(currentDate.split("T")[0].T);
	...
	function calculateEndTime(date, duration) {
		...
		// 	currentDate.getMinutes() + parseInt(duration) * 60000
		// ).toISOString();
		// let dateSample = currentDate;
	...
	function setStartTime(e) {
		...
		let currentTime = `${currentDate.split("T")[0]}.T${time}:00`;

		console.log(moment(currentTime).utc());
		// 2023-03-23T14:00:00
