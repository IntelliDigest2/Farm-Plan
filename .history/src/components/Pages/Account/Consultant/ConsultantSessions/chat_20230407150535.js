...
function Chat({ socket, onNotification, socketConnected, notification }) {
	...
	useEffect(() => {
		socket.on("new_message", (newMessageReceived) => {
			if (
				...
				//   give notifications
				if (!nofitication.includes(newMessageReceived)) {
					onNotification([newMessageReceived, ...notification]);
