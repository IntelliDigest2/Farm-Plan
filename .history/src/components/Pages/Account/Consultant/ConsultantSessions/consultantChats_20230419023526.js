...
export const ConsultantChats = (props) => {
	...
	const { userChats, getUserChats, auth } = props;
	...
	console.log(auth.uid, "this is the uid of the auth");
...
const mapDispatchToProps = (dispatch) => {
	return {
		getUserChats: (userId) => dispatch(getUserChatsData(userId)),
	};
};
