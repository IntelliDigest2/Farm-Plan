...
import { getConsultantChatsData } from "../../../../../store/actions/consultantActions/consultantActions";
...
export const ConsultantChats = ({ userId, userName }) => {
	...
	const getAllChatsForConsultant = () => {
		//get all chats
	};

	useEffect(() => {
		getAllChatsForConsultant();
	}, []);
...
const mapDispatchToProps = (dispatch) => {
	return {
		getConsultantChats: (consultantId) =>
			dispatch(getConsultantChatsData(consultantId)),
	};
};
