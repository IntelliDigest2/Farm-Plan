...
function ConsultantSessionsPage(props) {
	...
	useEffect(() => {
		...
		// console.log(props.getConsultantData("EAudRc5YajVorKygb0kZFGlfl163"));
	}, []);
...
const mapDispatchToProps = (dispatch) => {
	return {
		getConsultantData: (item) => dispatch(fetchConsultantData(item)),
	};
};

const mapStateToProps = (state) => {
	return {
		//   consultantInfo: state.data.purchaseData,
	};
};
