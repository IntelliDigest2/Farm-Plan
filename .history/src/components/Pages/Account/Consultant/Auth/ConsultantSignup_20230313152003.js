				...
				>
					...
					<Form.Group>
						<InputGroup className="mb-3">
							...
							>
								<Dropdown.Item href="#">phone call</Dropdown.Item>
								<Dropdown.Item href="#"> Written feedback</Dropdown.Item>
								<Dropdown.Item href="#">video call</Dropdown.Item>
								<Dropdown.Divider />
								<Dropdown.Item href="#">Visit to consultant</Dropdown.Item>
								<Dropdown.Item href="#">Consultant visitation</Dropdown.Item>
							</DropdownButton>
