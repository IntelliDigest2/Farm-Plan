...
const ConsultantSignup = (props) => {
	...
	// console.log(userServicesArray, "line 107");
	...
	let uploadedImg1 = img1 ? <img></img> : "";
	let uploadedImg2 = img2 ? <img></img> : "";
			...
			<section style={{ height: "auto" }} className="question-main">
				...
				<Form ref={form} style={{ marginTop: "180px" }}>
					...
					<Form.Group>
						...
						<Row className="mb=4">
							<Col>
								<Form.Control label="upload certificate" type="file" />
							</Col>
							<Col>
								<Form.Control className="mb3" label="upload Id" type="file" />
							</Col>
						</Row>
						<Row>
