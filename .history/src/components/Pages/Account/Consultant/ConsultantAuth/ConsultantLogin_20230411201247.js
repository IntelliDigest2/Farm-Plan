...
const ConsultantLogin = (props) => {
	...
	useEffect(() => {
		if (consultantAuthState.consultantLoggedIn) {
		...
		console.log(consultantAuthState);
	}, [consultantAuthState.consultantLoggedIn, history]);
...
const mapStateToProps = (state) => {
	return {
		...
		isLogError: state.consultantAuth.consultantLoggingError,
	};
};
