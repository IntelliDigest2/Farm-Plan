...
import { consultantSignup } from "../../../../../store/actions/consultantActions/consultantActions";
	...
	return (
		<div className="question-contanier">
			<section style={{ height: "auto" }} className="question-main">
				...
				<div>
					<h1 className="h5">
						Fill in the form below to start your journey as a consultant on the
						worldfoodTracker{" "}
					</h1>
					<p className="">All fields marked with * are required</p>
