...
const ConsultantSignup = (props) => {
	...
	const { isLoadingSignUp, signUpError, signUpSucces } = props;
	...
	useEffect(() => {
		setSignUpError(props.signUpError);
	}, [props.signUpError]);

	useEffect(() => {
		console.log(props.isLoadingSignUp, "this is the isLoading Signup");
		setIsLoading(props.isLoadingSignUp);
