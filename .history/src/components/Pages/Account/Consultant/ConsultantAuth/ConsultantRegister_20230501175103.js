...
const ConsultantRegister = (props) => {
	...
	const { isLoadingSignUp, signUpError, signUpSuccess, register } = props;
				...
				<div>
					...
					<Form ref={form}>
						...
						<Form.Group controlId="formBasicService" className="form-group">
							...
							<div style={{ display: "inherit" }}>{addNewServiceBtn}</div>
						...
						<Form.Group>
							<Form.Label style={{ width: "100%" }} className="form-label">
								Upload consultancy cerification and Id.
							</Form.Label>
							<Row className="mb-3">
								<Col>
									<Form.Control
