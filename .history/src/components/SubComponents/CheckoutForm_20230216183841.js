		...
		stripe
			.confirmPayment({
				...
				confirmParams: {
					...
					receipt_email: "<suppose to be the email of the usee>", //this is supposed to be the email of the user which a receipt would be sent to after a purchase is completed
				},
