...
import ConsultantSignup from "./components/Pages/Account/Consultant/ConsultantAuth/ConsultantSignup";
...
import BookConsulting from "./components/SubComponents/bookConsulting";
...
import userConsultingChatPage from "./components/SubComponents/userConsultingChatPage";
			...
			<Router>
				...
				<div>
					...
					<Switch>
						...
						/>
						<Route path="/consultingchats" component={userConsultingChatPage} />
						<Route path="/consult" component={BookConsulting} />
