...
export const consultantSignup = (data) => {
	return (dispatch, getState, { getFirestore, getFirebase }) => {
		...
		let newUserId;
		// Promise.all(uploadImgs(data.images, "787e7e0"))
		// 	.then((result) => {
		// 		console.log(result);
		// 	})
		// 	.catch((err) => {
		...
		firebase
			...
			.then((resp) => {
				...
				let userSubString = newUserId.substrin(0, 7);
			...
			.then((resp) => {
				...
				console.log(newUserId, "this is the userId for the new created user");
				console.log(
					resp,
					"this is the result from the response of storing the images"
				);
				firestore
