...
getFarmersInLocatonWithProducts.post("/farmers", async (req, res) => {
	...
	console.log(
		"🚀 ~ file: index.js:190 ~ arrayOfNamesOfObjectInCart ~ arrayOfNamesOfObjectInCart:",
	...
	farmersInCity.forEach(async (doc) => {
	...
	// console.log(typeof farmersInCity);

	// get all the users that have any of the products
	// farmersInCity.forEach(async (doc) => {
	// 	// if (condition) {

	// 	// }
	// 	let farmerWithProduct = await fireStoreDB
	// 		.collection("marketplace")
	// 		.doc(doc.id)
	// 		.collection("produce")
	// 		.where("item", "in", arrayOfNamesOfObjectInCart);

	// 	farmerWithProduct.forEach((doc) => {
	// 		console.log(doc.data());
	// 	});

	// 	// console.log(
	// 	// 	"🚀 ~ file: index.js:207 ~ farmersInCity.forEach ~ farmerWithProduct:"
	// 	// );
	// });
