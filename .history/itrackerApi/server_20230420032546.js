...
io.on("connection", (socket) => {
	...
	socket.on("new_message", (newMessageReceived) => {
		...
		console.log(newMessageReceived, "this is the message sent");
		// if (!chat.users) return console.log("chat.users not found");
		let newMessage = newMessageReceived.content;
		let senderId = newMessageReceived.senderId;
		...
		socket
			.to(newMessageReceived.receiverId)
			.emit("private_message", { newMessage, from: senderId });
	});
