...
class AddProductsAcademic extends Component {
    ...
    render() {
        ...
        return(
            ...
            >
            <MobileView><h6 style={{paddingTop: '8vh', color: 'black', justifyContent: 'center', display: 'flex'}}>Upload Food (Academic)</h6></MobileView>
            <BrowserView><h4 style={{paddingTop: '8vh', color: 'black', justifyContent: 'center', display: 'flex'}}>Upload Food (Academic)</h4></BrowserView>
...
export default compose(connect(mapStateToProps, mapDispatchToProps),firestoreConnect([{ collection: "data" }]))(AddProductsAcademic);
