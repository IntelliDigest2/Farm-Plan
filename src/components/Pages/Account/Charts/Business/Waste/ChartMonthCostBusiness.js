...
class Chart66 extends Component {
          ...
          .then( snapshot => {
            ...
            snapshot.forEach(doc => {
                ...
                if (month === time && (mdate === "1st" || mdate === "2nd" || mdate === "3rd" || mdate === "4th" || mdate === "5th" || mdate === "6th" || mdate === "7th") && isSurplus === "Edible" && st === "Waste"){
                  ...
                  this.setState( (prevState) => ({
                    week3CostBusiness: prevState.week3CostBusiness += newCost
                  }));
                  ...
                  this.setState( (prevState) => ({
                    week4CostBusiness: prevState.week4CostBusiness += newCost
                  }));
                }
            ...
            <React.Fragment className="row">
                ...
                <BrowserView>
                    ...
                    <div style={{height: "120%", marginBottom: "2.5%", marginLeft: "10%"}}>
                        <Chart className="bar-chart"
                            ...
                            data={[
                                ...
                                ['1st-7th', this.state.week1CostBusiness],
                                ['8th-14th', this.state.week2CostBusiness],
                                ['15th-21st', this.state.week3CostBusiness],
                                ['22nd-'+this.state.monthEnd, this.state.week4CostBusiness],
                            ]}
                            options={{
                                title: 'This month\'s Food Wastage Cost Performance (' + fullMonth + ', Business)',
                                chartArea: {width: '50%'},
                                colors: ['#aab41e'],
                                hAxis: {
                    ...
                    <div style={{height: "40px", marginBottom: "10%"}}>
                        ...
                        <ButtonGroup>
                            <Button style={{width: "15%"}} className="custom-btn" as={Link} to="/chart/weekCostBusiness">View Previous (Weekly Cost)</Button>
                            <Button style={{width: "7.5%"}} className="custom-btn" as={Link} to="/account">Back</Button>
                            <Button style={{width: "15%"}} className="custom-btn" as={Link} to="/chart/yearCostBusiness">View Next (Yearly Cost)</Button>
                        </ButtonGroup>
                        </Card>
                    </div>
                ...
                <MobileView>
                    ...
                    <div style={{height: "120%", marginBottom: "2.5%", marginLeft: "10%"}}>
                        <Chart className="bar-chart"
                            ...
                            options={{
                                title: 'Food Wastage Cost Performance (' + fullMonth + ', Business)',
                                chartArea: {width: '50%'},
                                colors: ['#aab41e'],
                                legend: "none",
                                hAxis: {
                    ...
                    <div style={{height: "95px", marginBottom: "15%"}}>
                        ...
                        <ButtonGroup>
                            <Button style={{width: "15%"}} className="custom-btn" as={Link} to="/chart/weekCostBusiness">Prev</Button>
                            <Button style={{width: "7.5%"}} className="custom-btn" as={Link} to="/account">Back</Button>
                            <Button style={{width: "15%"}} className="custom-btn" as={Link} to="/chart/yearCostBusiness">Next</Button>
                        </ButtonGroup>
                        </Card>
                    </div>
...
export default connect(mapStateToProps, null)(Chart66);