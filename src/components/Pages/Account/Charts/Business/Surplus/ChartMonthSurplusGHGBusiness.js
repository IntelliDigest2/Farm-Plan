...
class Chart72 extends Component {

    state = {
        uid: this.props.auth.uid,
        week1SurplusGHGBusiness: 0,
        week2SurplusGHGBusiness: 0,
        week3SurplusGHGBusiness: 0,
        week4SurplusGHGBusiness: 0,
        monthEnd: ""
    }
            ...
            snapshot.forEach(doc => {
                ...
                if (month === time && (mdate === "1st" || mdate === "2nd" || mdate === "3rd" || mdate === "4th" || mdate === "5th" || mdate === "6th" || mdate === "7th") && st === "Surplus Business" && (los === "Surplus Food" || los === "Surplus Local Produce")){
                  this.setState( (prevState) => ({
                    week1SurplusGHGBusiness: prevState.week1SurplusGHGBusiness += ghg
                  }));
                  ...
                  this.setState( (prevState) => ({
                    week2SurplusGHGBusiness: prevState.week2SurplusGHGBusiness += ghg
                  }));
                  ...
                  this.setState( (prevState) => ({
                    week3SurplusGHGBusiness: prevState.week3SurplusGHGBusiness += ghg
                  }));
                  ...
                  this.setState( (prevState) => ({
                    week4SurplusGHGBusiness: prevState.week4SurplusGHGBusiness += ghg
                  }));
                } 
            ...
            <React.Fragment className="row">
                ...
                <BrowserView>
                    ...
                    <div style={{height: "120%", marginBottom: "2.5%", marginLeft: "10%"}}>
                        <Chart className="bar-chart"
                            ...
                            data={[
                                ...
                                ['1st-7th', this.state.week1SurplusGHGBusiness],
                                ['8th-14th', this.state.week2SurplusGHGBusiness],
                                ['15th-21st', this.state.week3SurplusGHGBusiness],
                                ['22nd-'+this.state.monthEnd, this.state.week4SurplusGHGBusiness],
                            ]}
                            options={{
                                title: 'This month\'s Food Surplus GHG Saved Performance (' + fullMonth + ', Business)',
                                chartArea: {width: '50%'},
                                colors: ['rgb(13, 27, 92)'],
                                hAxis: {
                    ...
                    <div style={{height: "40px", marginBottom: "10%"}}>
                        ...
                        <ButtonGroup>
                            <Button style={{width: "15%"}} className="custom-btn" as={Link} to="/chart/weekSurplusGHGBusiness">View Previous (Weekly Surplus GHG)</Button>
                            <Button style={{width: "7.5%"}} className="custom-btn" as={Link} to="/account">Back</Button>
                            <Button style={{width: "15%"}} className="custom-btn" as={Link} to="/chart/yearSurplusGHGBusiness">View Next (Yearly Surplus GHG)</Button>
                        </ButtonGroup>
                        </Card>
                    </div>
                ...
                <MobileView>
                    ...
                    <div style={{height: "120%", marginBottom: "2.5%", marginLeft: "10%"}}>
                        <Chart className="bar-chart"
                            ...
                            options={{
                                title: 'Food Surplus GHG Saved Performance (' + fullMonth + ', Business)',
                                chartArea: {width: '50%'},
                                colors: ['rgb(13, 27, 92)'],
                                legend: "none",
                                hAxis: {
                    ...
                    <div style={{height: "95px", marginBottom: "15%"}}>
                        ...
                        <ButtonGroup>
                            <Button style={{width: "15%"}} className="custom-btn" as={Link} to="/chart/weekSurplusGHGBusiness">Prev</Button>
                            <Button style={{width: "7.5%"}} className="custom-btn" as={Link} to="/account">Back</Button>
                            <Button style={{width: "15%"}} className="custom-btn" as={Link} to="/chart/yearSurplusGHGBusiness">Next</Button>
                        </ButtonGroup>
                        </Card>
                    </div>
...
export default connect(mapStateToProps, null)(Chart72);