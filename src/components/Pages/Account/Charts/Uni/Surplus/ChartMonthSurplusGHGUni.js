...
class Chart54 extends Component {

    state = {
        uid: this.props.auth.uid,
        week1SurplusGHGUni: 0,
        week2SurplusGHGUni: 0,
        week3SurplusGHGUni: 0,
        week4SurplusGHGUni: 0,
        monthEnd: ""
    }
            ...
            <React.Fragment className="row">
                ...
                <BrowserView>
                    ...
                    <div style={{height: "120%", marginBottom: "2.5%", marginLeft: "10%"}}>
                        <Chart className="bar-chart"
                            ...
                            data={[
                                ...
                                ['1st-7th', this.state.week1SurplusGHGUni],
                                ['8th-14th', this.state.week2SurplusGHGUni],
                                ['15th-21st', this.state.week3SurplusGHGUni],
                                ['22nd-'+this.state.monthEnd, this.state.week4SurplusGHGUni],
                            ]}
                            options={{
                                title: 'This month\'s Food Surplus GHG Saved Performance (' + fullMonth + ', Academic)',
                                chartArea: {width: '50%'},
                                colors: ['rgb(13, 27, 92)'],
                                hAxis: {
                    ...
                    <div style={{height: "40px", marginBottom: "10%"}}>
                        ...
                        <ButtonGroup>
                            <Button style={{width: "15%"}} className="custom-btn" as={Link} to="/chart/weekSurplusGHGUni">View Previous (Weekly Surplus GHG)</Button>
                            <Button style={{width: "7.5%"}} className="custom-btn" as={Link} to="/account">Back</Button>
                            <Button style={{width: "15%"}} className="custom-btn" as={Link} to="/chart/yearSurplusGHGUni">View Next (Yearly Surplus GHG)</Button>
                        </ButtonGroup>
                        </Card>
                    </div>
                ...
                <MobileView>
                    ...
                    <div style={{height: "120%", marginBottom: "2.5%", marginLeft: "10%"}}>
                        <Chart className="bar-chart"
                            ...
                            options={{
                                title: 'Food Surplus GHG Saved Performance (' + fullMonth + ', Uni)',
                                chartArea: {width: '50%'},
                                colors: ['rgb(13, 27, 92)'],
                                legend: "none",
                                hAxis: {
                    ...
                    <div style={{height: "95px", marginBottom: "15%"}}>
                        ...
                        <ButtonGroup>
                            <Button style={{width: "15%"}} className="custom-btn" as={Link} to="/chart/weekSurplusGHGUni">Prev</Button>
                            <Button style={{width: "7.5%"}} className="custom-btn" as={Link} to="/account">Back</Button>
                            <Button style={{width: "15%"}} className="custom-btn" as={Link} to="/chart/yearSurplusGHGUni">Next</Button>
                        </ButtonGroup>
                        </Card>
                    </div>
...
export default connect(mapStateToProps, null)(Chart54);