...
class AddProductsFarm extends Component {
    ...
    render() {
        ...
        return(
            ...
            >
            <MobileView><h6 style={{paddingTop: '8vh', color: 'black', justifyContent: 'center', display: 'flex'}}>Upload Food (Farm)</h6></MobileView>
            <BrowserView><h4 style={{paddingTop: '8vh', color: 'black', justifyContent: 'center', display: 'flex'}}>Upload Food (Farm)</h4></BrowserView>
...
export default compose(connect(mapStateToProps, mapDispatchToProps),firestoreConnect([{ collection: "data" }]))(AddProductsFarm);
