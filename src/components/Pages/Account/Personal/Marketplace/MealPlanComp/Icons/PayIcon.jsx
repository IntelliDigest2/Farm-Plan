...
const PayIcon =
  ...
  ({ setPrice, price, index, disabled, newRef, ...props }) => {
    ...
    const otherUrl =
      "https://us-central1-itracker-development.cloudfunctions.net/itrackerPaymentFunction/create-payment-intent";
      ...
      await fetch(`${baseUrlProd}/v1/payment/initiate-payment`, {
        ...
        .then((data) => {
          ...
          changePurchaseStatus(
            props.consultantPaymentInfo.bookingId,
            props.consultantPaymentInfo.consultantId,
...
const mapDispatchToProps = (dispatch) => {
  return {
    editPurchaseStatusFromUser: (data) =>
      dispatch(editPurchaseStatusFromUser(data)),
