...
const SubSignUp = (props) => {
  ...
  const [errorNotification, setErrorNotification] = useState();
    ...
    useEffect(() => {
      if (props.auth.buildingFunction === "Offices") {
        setIsLoggedIn(true);
        if (town !== "" && country !== "") {
        ...
        return (
          <Title subtitle="Sign Up">
            ...
            <div className="signup-center subtitles row">
              ...
              <Link style={{ color: "#AFBA15" }} to="/sub-login">
                {"  "}
                Log In
              </Link>
            </div>
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(SubSignUp);
