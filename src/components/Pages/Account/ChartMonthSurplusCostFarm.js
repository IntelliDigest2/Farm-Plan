...
class Chart84 extends Component {

    state = {
        uid: this.props.auth.uid,
        week1SurplusCostFarm: 0,
        week2SurplusCostFarm: 0,
        week3SurplusCostFarm: 0,
        week4SurplusCostFarm: 0,
        monthEnd: ""
    }
            ...
            snapshot.forEach(doc => {
                ...
                if (month === time && (mdate === "1st" || mdate === "2nd" || mdate === "3rd" || mdate === "4th" || mdate === "5th" || mdate === "6th" || mdate === "7th") && st === "Surplus Farm" && (los === "Surplus Food" || los === "Surplus Local Produce")){
                  this.setState( (prevState) => ({
                    week1SurplusCostFarm: prevState.week1SurplusCostFarm += newCost
                  }));
                  ...
                  this.setState( (prevState) => ({
                    week2SurplusCostFarm: prevState.week2SurplusCostFarm += newCost
                  }));
                  ...
                  this.setState( (prevState) => ({
                    week3SurplusCostFarm: prevState.week3SurplusCostFarm += newCost
                  }));
                  ...
                  this.setState( (prevState) => ({
                    week4SurplusCostFarm: prevState.week4SurplusCostFarm += newCost
                  }));
                }
            })
            ...
            <React.Fragment className="row">
                ...
                <BrowserView>
                    ...
                    <div style={{height: "120%", marginBottom: "2.5%", marginLeft: "10%"}}>
                        <Chart className="bar-chart"
                            ...
                            data={[
                                ...
                                ['1st-7th', this.state.week1SurplusCostFarm],
                                ['8th-14th', this.state.week2SurplusCostFarm],
                                ['15th-21st', this.state.week3SurplusCostFarm],
                                ['22nd-'+this.state.monthEnd, this.state.week4SurplusCostFarm],
                            ]}
                            options={{
                                title: 'This month\'s Food Surplus Costs Saved Performance (' + fullMonth + ', Farm)',
                                chartArea: {width: '50%'},
                                colors: ['rgb(13, 27, 92)'],
                                hAxis: {
                    ...
                    <div style={{height: "40px", marginBottom: "10%"}}>
                        ...
                        <ButtonGroup>
                            <Button style={{width: "15%"}} className="custom-btn" as={Link} to="/chart/weekSurplusCostFarm">View Previous (Weekly Surplus Cost)</Button>
                            <Button style={{width: "7.5%"}} className="custom-btn" as={Link} to="/account">Back</Button>
                            <Button style={{width: "15%"}} className="custom-btn" as={Link} to="/chart/yearSurplusCostFarm">View Next (Yearly Surplus Cost)</Button>
                        </ButtonGroup>
                        </Card>
                    </div>
                ...
                <MobileView>
                    ...
                    <div style={{height: "120%", marginBottom: "2.5%", marginLeft: "10%"}}>
                        <Chart className="bar-chart"
                            ...
                            options={{
                                title: 'Food Surplus Costs Saved Performance (' + fullMonth + ', Farm)',
                                chartArea: {width: '50%'},
                                colors: ['rgb(13, 27, 92)'],
                                legend: "none",
                                hAxis: {
                    ...
                    <div style={{height: "95px", marginBottom: "15%"}}>
                        ...
                        <ButtonGroup>
                            <Button style={{width: "15%"}} className="custom-btn" as={Link} to="/chart/weekSurplusCostFarm">Prev</Button>
                            <Button style={{width: "7.5%"}} className="custom-btn" as={Link} to="/account">Back</Button>
                            <Button style={{width: "15%"}} className="custom-btn" as={Link} to="/chart/yearSurplusCostFarm">Next</Button>
                        </ButtonGroup>
                        </Card>
                    </div>
...
export default connect(mapStateToProps, null)(Chart84);