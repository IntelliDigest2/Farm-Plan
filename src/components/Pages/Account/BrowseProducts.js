...
import "../../../App.css";
import "../Pages.css"
import {Button, Card, Col, Row, Tab, Nav, InputGroup, Form, Modal} from 'react-bootstrap'
        ...
        return (
            ...
            <Modal show={this.state.showDevMessage} onHide={() => this.setState({showDevMessage: !this.state.showDevMessage})}>
                ...
                <Modal.Body>
                    <p>This page is in the very early stages of development. If you have any suggestions
                        on how to improve it, you can send them to us via the Contact Page.
                    </p>
                </Modal.Body>
                <Modal.Footer>
            ...
            <BrowserView>
                <div className="main-div-layout">
                    ...
                    <InputGroup style={{left: "50%", right: "50%", transform: "translate(-50%, -50%)", marginTop: "7%", width: "40%"}}>
                        <BsSearch style={{marginRight: "5px", fontSize: "30px"}}/>
                        <Form.Control placeholder="Search"  />
                    </InputGroup>
                </div>
                <div className="main-div-layout" style={{marginTop: "10px", marginLeft: "25px"}}>  
                    <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                        <Row>
                            <Col sm={3}>
                            <Nav variant="pills" className="flex-column">
                                <Nav.Item>
                                <Nav.Link eventKey="first" style={{backgroundColor: "red", color: "white", marginBottom: "10px"}}>Meat & Fish</Nav.Link>
                                </Nav.Item>
                                <Nav.Item>
                                <Nav.Link eventKey="second" style={{backgroundColor: "rgb(94, 120, 235)", color: "white", marginBottom: "10px"}}>Frozen</Nav.Link>
                                </Nav.Item>
                                <Nav.Item>
                                <Nav.Link eventKey="third" style={{backgroundColor: "rgb(76, 226, 106)", color: "white", marginBottom: "10px"}}>Dairy, Eggs & Chilled</Nav.Link>
                                </Nav.Item>
                                <Nav.Item>
                                <Nav.Link eventKey="fourth" style={{backgroundColor: "rgb(8, 105, 27)", color: "white", marginBottom: "10px"}}>Fruit & Veg</Nav.Link>
                                </Nav.Item>
                                <Nav.Item>
                                <Nav.Link eventKey="fifth" style={{backgroundColor: "rgb(245, 211, 20)", color: "white", marginBottom: "10px"}}>Bakery</Nav.Link>
                                </Nav.Item>
                                <Nav.Item>
                                <Nav.Link eventKey="sixth" style={{backgroundColor: "rgb(12, 34, 131)", color: "white", marginBottom: "10px"}}>Drinks</Nav.Link>
                                </Nav.Item>
                                <Nav.Item>
                                <Nav.Link eventKey="seventh" style={{backgroundColor: "rgb(168, 113, 11)", color: "white", marginBottom: "10px"}}>Pet</Nav.Link>
                                </Nav.Item>
                            </Nav>
                            </Col>
                            <Col sm={9}>
                            <Tab.Content>
                                <Tab.Pane eventKey="first">
                                    <CardStyle>
                                        <Card className="outer-card" style={{width: "600px", height: "450px"}}>
                                            ...
                                            <Card className="inner-card" style={{marginBottom: "7.5px"}}>
                                                ...
                                                <div><b>Expiry Date: {" "}</b>30/07/2021</div>
                                                <div><b>Postcode {" "}</b>EX1 2XE</div>
                                                <Button style={{backgroundColor: "red", width: "15%", marginLeft: "80%", marginTop: "-60px", marginBottom: "25px"}}>View</Button>
                                            </Card>
                                            <Card>
                                                <div><b>Product: {" "}</b>Chicken</div>
                                                <div><b>Weight: {" "}</b>200g</div>
                                                <div><b>Expiry Date: {" "}</b>29/07/2021</div>
                                    ...
                                    <CardStyle>
                                        <Card className="outer-card" style={{width: "600px", height: "450px"}}>
                                            ...
                                            <Card className="inner-card">
                                                ...
                                                <Button style={{backgroundColor: "rgb(94, 120, 235)", width: "15%", marginLeft: "80%", marginTop: "-60px", marginBottom: "25px"}}>View</Button>
                                            </Card>
                                        </Card>
                                    </CardStyle>
                                </Tab.Pane>
                                <Tab.Pane eventKey="third">
                                    <CardStyle>
                                        <Card className="outer-card" style={{width: "600px", height: "450px"}}>
                                            ...
                                            <div className="text-center"><b>n/a</b></div>
                                        </Card>
                                    </CardStyle>
                                </Tab.Pane>
            ...
            <MobileView>
                <div className="main-div-layout" style={{height: "180vh", width: "95%", marginTop: "13%", padding: "10px 10px 5px 25px"}}>
                    ...
                    <InputGroup style={{marginTop: "2%", marginBottom: "35px"}}>
                        <BsSearch style={{marginRight: "2%", marginTop: "1.5%", fontSize: "30px"}}/>
                        <Form.Control placeholder="Search"  />
                    </InputGroup>
                    ...
                    <Accordion style={{marginBottom: "10px", backgroundColor: "red"}}>
                        <AccordionSummary
                            ...
                            id="panel1a-header"
                        >
                            <Typography style={{color: "white"}}>Meat & Fish</Typography>
                        </AccordionSummary>

                        <AccordionDetails style={{justifyContent: "center", marginBottom: "15px", backgroundColor: "white", marginBottom: -1}}>
                            {/* <Typography>
                                ABCDEFGH
                            </Typography> */}
                            ...
                            <div style={{marginTop: "10px", marginBottom: "15px"}}>
                                ...
                                <div><b>Expiry Date: {" "}</b>30/07/2021</div>
                                <div><b>Postcode: {" "}</b>EX1 2XE</div>
                                <Button style={{backgroundColor: "red", marginLeft: "10vw", marginTop: "10px"}}>View</Button>
                    ...
                    <Accordion style={{marginBottom: "10px", backgroundColor: "rgb(103, 169, 226)"}}>
                        ...
                        <AccordionDetails style={{justifyContent: "center", marginBottom: "15px", backgroundColor: "white", marginBottom: -1}}>
                            ...
                            <div style={{marginTop: "10px", marginBottom: "15px"}}>
                                ...
                                <div><b>Expiry Date: {" "}</b>13/11/2021</div>
                                <div><b>Postcode: {" "}</b>PC1 1CP</div>
                                <Button style={{backgroundColor: "rgb(103, 169, 226)", marginLeft: "10vw", marginTop: "10px"}}>View</Button>
                            </div>
                            </Typography>
                        </AccordionDetails>
                    ...
                    <Accordion style={{marginBottom: "10px", backgroundColor: "rgb(76, 226, 106)"}}>
                        <AccordionSummary
                            ...
                            id="panel2a-header"
                        >
                            <Typography style={{color: "white"}}>Dairy, Eggs & Chilled</Typography>
                        </AccordionSummary>
                    ...
                    <Accordion style={{marginBottom: "10px", backgroundColor: "rgb(8, 105, 27)"}}>
                        <AccordionSummary
                            ...
                            id="panel2a-header"
                        >
                            <Typography style={{color: "white"}}>Fruit & Veg</Typography>
                        </AccordionSummary>
                        ...
                        <AccordionDetails style={{justifyContent: "center", marginBottom: "15px", backgroundColor: "white", marginBottom: -1}}>
                            ...
                            <div style={{marginTop: "10px", marginBottom: "15px"}}>
                                ...
                                <div><b>Expiry Date: {" "}</b>19/08/2021</div>
                                <div><b>Postcode: {" "}</b>AA0 BB1</div>
                                <Button style={{backgroundColor: "rgb(8, 105, 27)", marginLeft: "10vw", marginTop: "10px"}}>View</Button>
                            </div>
                            </Typography>
                        </AccordionDetails>
