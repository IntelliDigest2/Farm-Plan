                ...
                <div>
                    ...
                    <Form.Group
                        ...
                        <InputGroup>
                            <DDMenuStyle>
                                <Dropdown>
                                    <DropdownToggle variant="secondary" style={{width: "190px"}} className="dd">{this.state.foodCategory}</DropdownToggle>
                                    <DropdownMenu>
...
export default compose(connect(mapStateToProps, mapDispatchToProps),firestoreConnect([{ collection: "data" }]))(FoodSurplus);