                        ...
                        <>
                            <BrowserView>
                                <Card style={{width: "95%", marginLeft: "2.5%", backgroundColor: "rgb(38, 120, 214)", height: "100px", marginBottom: "50px"}}>
                                    ...
                                    <div>
                                        <div className="exp-date" style={{marginLeft: "80%", height: "60px", width: "15%", marginTop: "-11%"}}>
                                            Price: £{product.price}
                                        </div>
...
export default compose(connect(mapStateToProps, mapDispatchToProps),firestoreConnect([{ collection: "data" }]))(AddProducts);
