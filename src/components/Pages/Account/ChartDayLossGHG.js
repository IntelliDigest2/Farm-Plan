                   ...
                   <div style={{height: "120%", marginBottom: "2.5%", marginLeft: "10%"}}>
                    ...
                    <div style={{height: "40px", marginBottom: "10%"}}>
                        ...
                        <ButtonGroup>
                            ...
                            <Button style={{width: "15%"}} className="custom-btn" as={Link} to="/chart/weekLossGHG">View Next (Weekly Loss GHG)</Button>
                        </ButtonGroup>
                        </Card>
                    </div>
                   ...
                   <div style={{height: "120%", marginBottom: "2.5%", marginLeft: "10%"}}>
                    ...
                    <div style={{height: "95px", marginBottom: "10%"}}>
                        ...
                        <ButtonGroup>
                            <Button style={{width: "15%"}} disabled>View Previous</Button>
                            <Button style={{width: "7.5%"}} className="custom-btn" as={Link} to="/account">Back</Button>
                            <Button style={{width: "15%"}} className="custom-btn" as={Link} to="/chart/weekLossGHG">View Next</Button>
                        </ButtonGroup>
                        </Card>
                    </div>
