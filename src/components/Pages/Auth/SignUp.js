    ...
    return (
      ...
      <React.Fragment>
        <Row className="mr-0 ml-0 justify-content-center align-items-center signup">
          <Col
            className="d-block mt-5 pt-5 pb-5 mb-5 pb-lg-0 mb-lg-0 mt-lg-0 pt-lg-0"
            sm={12}
            md={12}
            lg={5}
          ...
          >
            <FormStyle>
              ...
              <h1 className="text-center header">
                Sign Up to The Global Food Loss & Waste Tracker
              </h1>
              <div>
                  ...
                  <Form>
                    ...
                    <Form.Group>
                      ...
                      >
                        ...
                        <option value="Restraunts">Restaurants</option>
                        <option value="Shop/Supermarket">
                          Shop/Supermarket
                        </option>
                        <option value="Farm">Farm</option>
                        <option value="Recreational Centers">
                    ...
                    {this.state.function === "Households" ? (
                      ...
                      <>
                        ...
                        <div>
                          {this.state.schoolType === "University" ? (
                            <>
                              <Form.Group>
                                <Form.Label>Name of organisation</Form.Label>
                                <Form.Control
                  ...
                  {/* <option value="Pet Food">Pet Food</option> */}
                    ...
                    <p className="text-center terms">
                      ...
                      <a
                        ...
                        href="https://intellidigest.com/terms-conditions/?doing_wp_cron=1624534322.2405810356140136718750"
                        target="_blank"
                      ...
                      <a
                        ...
                        href="https://intellidigest.com/privacy-policy/?doing_wp_cron=1624534455.5444190502166748046875"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        Privacy Policy
              ...
              <p style={{ marginBottom: "10%" }} className="text-center terms">
                Already a member?{" "}
          ...
          <Col
            className="bg-image new-signup-graphic d-none d-sm-none d-md-none d-lg-block"
            sm={12}
            md={12}
            lg={7}
            style={{ height: "100vh" }}
