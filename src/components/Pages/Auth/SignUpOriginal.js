  ...
  return (
    ...
    <Row className="mr-0 ml-0 justify-content-center align-items-center signup">
            <Col className="d-block mt-5 pt-5 pb-5 mb-5 pb-lg-0 mb-lg-0 mt-lg-0 pt-lg-0" sm={12} md={12} lg={5}>
              ...
              <Form.Row>
              <Form.Group as={Col} controlId="signupFormName">
              <Form.Label>Name</Form.Label>
                <Form.Control type="text" id="firstName" placeholder="Name" required/>
              </Form.Group>
          
              <Form.Group as={Col} controlId="signupFormSurname">
              <Form.Label>Surname</Form.Label>
                <Form.Control type="text" id="lastName" placeholder="Surname" required />
              </Form.Group>
            </Form.Row>

            <Form.Group controlId="signupFormAddress">
                <Form.Label>Address (including Postcode)</Form.Label>
                <Form.Control type="text" id="address" placeholder="Address" required/>
              </Form.Group>

              <Form.Group controlId="signupFormEmail">
                <Form.Label>Email</Form.Label>
                <Form.Control type="email" id="email" placeholder="Email" ref={emailRef} required/>
              </Form.Group>

              <Form.Group controlId="signupFormPassword">
                <Form.Label>Password</Form.Label>
                <Form.Control type="password" id="password" placeholder="Password" ref={passwordRef} required/>
              </Form.Group>

              <Form.Group controlId="signupFormRepeatPassword">
                <Form.Label>Repeat Password</Form.Label>
                <Form.Control type="password" id="repeatPass" placeholder="Repeat Password" ref={repeatPasswordRef} required/>
              </Form.Group>
